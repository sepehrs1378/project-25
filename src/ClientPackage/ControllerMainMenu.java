...
public class ControllerMainMenu {
    ...
    void enterCustomCardMenu(MouseEvent event) throws IOException {
        Main.playWhenButtonClicked();
        Parent root = FXMLLoader.load(getClass().getResource("ClientPackage/ControllerCustomCard.fxml"));
        Main.window.setScene(new Scene(root));
        Main.setCursor();
    }
    ...
    void showMatchHistory(MouseEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("ClientPackage/ControllerMatchInfo.fxml"));
    ...
    void goBack(MouseEvent event) throws IOException {
        Main.playWhenButtonClicked();
        Parent root = FXMLLoader.load(getClass().getResource("ClientPackage/ControllerAccount.fxml"));
        Main.window.setScene(new Scene(root));
        Main.setCursor();
    }
    ...
    void enterSinglePlayer(MouseEvent event) throws IOException {
        Main.playWhenButtonClicked();
        Parent root = FXMLLoader.load(getClass().getResource("ClientPackage/ControllerSinglePlayerMenu.fxml"));
        stage = new Stage();
    ...
    void enterCollection(MouseEvent event) throws IOException {
        Main.playWhenButtonClicked();
        Parent root = FXMLLoader.load(getClass().getResource("ClientPackage/ControllerCollection.fxml"));
        Main.window.setScene(new Scene(root));
        Main.setCursor();
    }
    ...
    void enterShop(MouseEvent event) throws IOException {
        Main.playWhenButtonClicked();
        Parent root = FXMLLoader.load(getClass().getResource("ClientPackage/ControllerShop.fxml"));
        Main.window.setScene(new Scene(root));
