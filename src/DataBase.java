...
//        System.out.println(usableList.size());
    ...
    private void makeCardSpells() {
        ...
        DisarmBuff totalDisarmBuff = new DisarmBuff(1000, true, false, 0);
        ...
        InfernoBuff hellFireBuff = new InfernoBuff(2, false, false, 0, 1);
        ...
        PoisonBuff poisonLakeBuff = new PoisonBuff(1, false, false, 0, 1);
        ...
        DisarmBuff madnessBuff1 = new DisarmBuff(3, true, false, 0);
        PowerBuff madnessBuff2 = new PowerBuff(3, true, false, 0, 4, 0);
        ...
        DisarmBuff allDisarmBuff = new DisarmBuff(1, true, false, 0);
        ...
        PoisonBuff allPoisonBuff = new PoisonBuff(4, true, false, 0, 1);
        ...
        WeaknessBuff healthWithProfitBuff1 = new WeaknessBuff(Integer.MAX_VALUE, true, false, 0, 6, 0);
        HolyBuff healthWithProfitBuff2 = new HolyBuff(3, true, false, 2, 0);
        ...
        PowerBuff powerUpBuff = new PowerBuff(Integer.MAX_VALUE, true, false, 0, 6, 0);
        ...
        PowerBuff allPowerBuff = new PowerBuff(Integer.MAX_VALUE, true, false, 0, 2, 0);
        ...
        WeaknessBuff weakeningBuff = new WeaknessBuff(Integer.MAX_VALUE, true, false, 0, 0, 4);
        ...
        WeaknessBuff sacrificeBuff1 = new WeaknessBuff(Integer.MAX_VALUE, true, false, 0, 6, 0);
        PowerBuff sacrificeBuff2 = new PowerBuff(Integer.MAX_VALUE, true, false, 0, 8, 0);
        ...
        StunBuff shockBuff = new StunBuff(2, true, false, 0);
    ...
    private void makeHeroes() {
        ...
        PowerBuff divSefidBuff = new PowerBuff(Integer.MAX_VALUE, true, false, 0, 4, 0);
        ...
        StunBuff simorghBuff = new StunBuff(1, true, false, 0);
        ...
        DisarmBuff ejdehaHaftSarBuff = new DisarmBuff(Integer.MAX_VALUE, true, false, 0);
        ...
        StunBuff rakhshBuff = new StunBuff(1, true, false, 0);
        ...
        PoisonBuff zhakBuff = new PoisonBuff(3, true, false, 0, 1);
        ...
        HolyBuff kavehBuff = new HolyBuff(3, true, false, 1, 0);
        ...
        HolyBuff esfandiarBuff = new HolyBuff(Integer.MAX_VALUE, false, true, 3, 0);
    ...
    private void makeMinions() {
        ...
        StunBuff shamshirZanFarsBuff = new StunBuff(1, true, false, 0);
...
//        cardList.add(pahlevanFars);
        ...
        DisarmBuff jasoosTooraniBuff1 = new DisarmBuff(1, true, false, 0);
        PoisonBuff jasoosTooraniBuff2 = new PoisonBuff(4, true, false, 0, 1);
...
//        Target oghabTarget = new Target(Constants.MINION, 1, 1, Constants.FRIEND, false, false, 0, Constants.ALL);
        ...
        PowerBuff oghabBuff = new PowerBuff(Integer.MAX_VALUE, true, false, 10, 0, 0);
        ...
        PoisonBuff marSamiBuff = new PoisonBuff(3, true, false, 0, 1);
        ...
        ImmunityBuff shirDarandeBuff = new ImmunityBuff(Integer.MAX_VALUE, true, false, 0, Constants.HOLY_BUFF);
        ...
        NegativeArmorBuff marGhoolPeikarBuff = new NegativeArmorBuff(Integer.MAX_VALUE, true, false, 0, 1);
        ...
        WeaknessBuff palangBuff = new WeaknessBuff(1, true, false, 0, 8, 0);
        ...
        WeaknessBuff gorgBuff = new WeaknessBuff(1, true, false, 0, 6, 0);
        ...
        PowerBuff jadoogarBuff1 = new PowerBuff(1, true, false, 0, 2, 0);
        WeaknessBuff jadoogarBuff2 = new WeaknessBuff(1, true, false, 0, 1, 0);
        ...
        PowerBuff jadoogarAzamBuff1 = new PowerBuff(1, true, false, 0, 2, 0);
        HolyBuff jadoogarAzamBuff2 = new HolyBuff(1, true, true, 1, 0);
        ...
        PowerBuff genBuff = new PowerBuff(Integer.MAX_VALUE, true, true, 0, 1, 0);
        ...
        ImmunityBuff gorazVahshiBuff = new ImmunityBuff(Integer.MAX_VALUE, true, false, 0, Constants.DISARM);
        ...
        ImmunityBuff piranBuff = new ImmunityBuff(Integer.MAX_VALUE, true, false, 0, Constants.POISON);
        ...
        ImmunityBuff givBuff = new ImmunityBuff(Integer.MAX_VALUE, true, false, 0, Constants.ENEMY_CARD_SPELL);
        ...
        ImmunityBuff ashkboosBuff = new ImmunityBuff(Integer.MAX_VALUE, true, false, 0, Constants.WEAKER_AP);
        ...
        StunBuff naneSarmaBuff = new StunBuff(1, true, false, 0);
        ...
        HolyBuff fooladZerehBuff = new HolyBuff(Integer.MAX_VALUE, true, true, 12, 0);
        ...
        WeaknessBuff siavashBuff = new WeaknessBuff(1, false, false, 0, 6, 0);
    ...
    private void makeItems() {
        ...
        ManaBuff tajDanayeeBuff = new ManaBuff(3, false, false, 0, 1);
        ...
        HolyBuff namoosSeparBuff = new HolyBuff(Integer.MAX_VALUE, true, false, 12, 0);
        ...
        DisarmBuff kamanDamoolBuff = new DisarmBuff(1, true, false, 0);
        //String descUsable1 = "price : 300";
        //todo
        usableList.add(namoosSepar);
        //usableList.add(null);
        ...
        PowerBuff exirBuff = new PowerBuff(Integer.MAX_VALUE, true, false, 0, 3, 0);
        ...
        ManaBuff majoonManaBuff = new ManaBuff(1, false, false, 0, 3);
        ...
        HolyBuff majoonRooinTaniBuff = new HolyBuff(2, true, false, 10, 0);
        ...
        ManaBuff kingWisdomBuff = new ManaBuff(Integer.MAX_VALUE, false, false, 0, 1);
        ...
        PoisonBuff poisonousDaggerSpellBuff = new PoisonBuff(1, true, false, 0, 1);
        ...
        DisarmBuff shockHammerSpellBuff = new DisarmBuff(1, true, false, 0);
        ...
        PowerBuff soulEaterSpellBuff = new PowerBuff(Integer.MAX_VALUE, true, false, 0, 0, 1);
        ...
        HolyBuff ghoslTamidBuff = new HolyBuff(2, true, false, 1, 0);
